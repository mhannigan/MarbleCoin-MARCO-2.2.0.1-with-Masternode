...
bool CheckStakeKernelHash(unsigned int nBits, const CBlock& blockFrom, unsigned int nTxPrevOffset, const CTransaction& txPrev, const COutPoint& prevout, unsigned int nTimeTx, uint256& hashProofOfStake, uint256& targetProofOfStake, bool fPrintProofOfStake)
{
    ...
    if (nTimeBlockFrom + nStakeMinAge > nTimeTx) { // Min age requirement 
		LogPrintf("CheckStakeKernelHash(): min age violatnion, nTimeBlockFrom=%u, nStakeMinAge=%u, nTimeBlockFrom+nStakeMinAge=%u, nTimeTx=%u\n",nTimeBlockFrom, nStakeMinAge, nTimeBlockFrom+nStakeMinAge, nTimeTx);
    ...
    //CBigNum bnCoinDayWeight = CBigNum(nValueIn) * GetWeight((int64_t)txPrev.nTime, (int64_t)nTimeTx) / COIN / (24*60); //DEBUG!!!
...
bool CheckKernel(CBlockIndex* pindexPrev, unsigned int nBits, int64_t nTime, const COutPoint& prevout, int64_t* pBlockTime)
{
    ...
    return CheckStakeKernelHash(nBits, block, txindex.pos.nTxPos - txindex.pos.nBlockPos, txPrev, prevout, nTime, hashProofOfStake, targetProofOfStake);
}
